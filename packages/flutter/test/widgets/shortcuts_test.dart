...
class TestDispatcher extends ActionDispatcher {
  ...
  @override
  Object? invokeAction(Action<TestIntent> action, Intent intent,
      [BuildContext? context]) {
    final Object? result = super.invokeAction(action, intent, context);
    postInvoke?.call(
        action: action, intent: intent, context: context, dispatcher: this);
    return result;
  }
}
...
void main() {
  ...
  group(Shortcuts, () {
    testWidgets('Default constructed Shortcuts has empty shortcuts',
        (WidgetTester tester) async {
    ...
    testWidgets('Shortcuts.of and maybeOf find shortcuts',
        (WidgetTester tester) async {
      ...
      expect(
          Shortcuts.maybeOf(containerKey.currentContext!), equals(testManager));
      expect(Shortcuts.of(containerKey.currentContext!), equals(testManager));
    });
    testWidgets('Shortcuts.of and maybeOf work correctly without shortcuts',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
    ...
    testWidgets('ShortcutManager handles shortcuts',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
      final List<LogicalKeyboardKey> pressedKeys = <LogicalKeyboardKey>[];
      final TestShortcutManager testManager = TestShortcutManager(pressedKeys);
    ...
    testWidgets('ShortcutManager ignores keypresses with no primary focus',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
      final List<LogicalKeyboardKey> pressedKeys = <LogicalKeyboardKey>[];
      final TestShortcutManager testManager = TestShortcutManager(pressedKeys);
    ...
    testWidgets('Shortcuts support multiple intents',
        (WidgetTester tester) async {
  ...
  group('CharacterActivator', () {
    testWidgets('is triggered on events with correct character',
        (WidgetTester tester) async {
      int invoked = 0;
      await tester.pumpWidget(activatorTester(
  ...
  group('CallbackShortcuts', () {
    ...
    testWidgets('nested CallbackShortcuts stop propagation',
        (WidgetTester tester) async {
      int invokedOuter = 0;
      int invokedInner = 0;
      await tester.pumpWidget(
    ...
    testWidgets('Works correctly with Shortcuts too',
        (WidgetTester tester) async {
